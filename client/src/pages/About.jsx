  ...
  return (
    <div className='px-4 py-12 max-w-2xl mx-auto'>
      ...
      <p className='mb-4 text-slate-700'>
        ...
        using JSON Web Tokens (JWT) as well as firebase for data security.
      </p>
      <p className='mb-4 text-slate-700'>
      ...
      <footer className='flex gap-3'><h1 className='text-red-500 font-bold size-5 from-neutral-700 Author: Raju Yadav '></h1>
      <h5 className='text-red-500 font-bold size-5 from-neutral-700 NickName: Raaz Veer Yadav '></h5></footer>
    </div>
  );
}
